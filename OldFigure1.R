...
# Plot of 5 time series replicates stopping at the breakpoint
#par(bty="n", xaxt="n", yaxt="n", oma=c(1,1,1,2))
matplot(1:tau1, ts.reps[1:tau1,], type="l", col=rep("darkgrey",5), lty=rep(1,5), ylim=c(mu1-3, mu2+3), xlim=c(-5,len1+30), xlab="Time", ylab="Log population abundance", cex.lab=1.5)
...
arrows(x0=tau1-7,y0=yz+1.3,x1=mid.thalf,y1=yz*1.03,code=2, length=0.07,lwd=2)

# Half life label
text(x=tau1-9, y=yz+1.7, labels="Half life", cex=1.25)
